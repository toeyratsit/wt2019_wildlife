...
const textNodes = [{
    ...
    {
        id: 2,
        text: 'สัตว์จำพวกเลี้ยงลูกด้วยนมตัวใดมีความเสี่ยงสูญพันธุ์มากที่สุด ? ',
        options: [{
                text: 'กระซู่',
                nextText: 3
            },
    ...
    {
        id: 3,
        text: 'สัตว์ในข้อใดที่ในประเทศไทยได้สูญพันธุ์ไปแล้ว ?',
        options: [{
                text: 'กวางผา',
                nextText: 13
            },
    ...
    },
    {
        ...
        options: [{
                ...
                text: 'พะยูนโดยทั่วไปจะอาศัยอยู่ในบริเวณน้ำลึก นอกจากขึ้นมาหากินใกล้ฝั่งเท่านั้น',
                nextText: 14
            },
            {
    ...
    {
        id: 6,
        text: 'สัตว์ในข้อใดมีระยะเวลาการตั้งท้องเป็นเวลา 9 เดือน ?',
        options: [{
                text: 'สมเสร็จ',
                nextText: 16
            },
    ...
    {
        id: 7,
        text: 'สัตว์ในข้อใดที่ถูกบรรจุเพิ่มเข้ามาใหม่ในรายชื่อสัตว์สงวน ?',
        options: [{
                text: 'ละมั่ง',
                nextText: 17
            },
    ...
    {
        id: 8,
        text: 'ฉลามวาฬมีครีบอกและครีบหางอย่างละกี่อัน ?',
        options: [{
    ...
    {
        id: 9,
        text: 'สัตว์ในข้อใดแตกต่างจากพวก ?',
        options: [{
                text: 'วาฬบรูด้า',
                nextText: 10
            },
